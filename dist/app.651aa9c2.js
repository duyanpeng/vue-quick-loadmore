...
},{}],"src/VueQuickLoadmore.vue":[function(require,module,exports) {
"use strict";
...
exports.default = {
  ...
  return _c(
    "div",
    {
      staticClass: "vsim-load",
      style: { overflow: _vm.bottomOverflow },
      on: {
    ...
    [
      _c(
        "div",
        { ref: "content", staticClass: "vsim-load-content" },
        [
          _vm._t("top", [
            _c("div", { staticClass: "vsim-load-header" }, [
              _c("div", [_vm._v(_vm._s(_vm.topText))])
            ])
          ]),
          _vm._v(" "),
          _vm._t("default"),
          _vm._v(" "),
          _vm._t("bottom", [
            _c("div", { staticClass: "vsim-load-footer" }, [
              _c("div", [_vm._v(_vm._s(_vm.bottomText))])
            ])
          ])
        ],
        2
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$44ea29', $44ea29);
          } else {
            api.reload('$44ea29', $44ea29);
          }
        }
...
var _VueQuickLoadmore = require('./VueQuickLoadmore.vue');

var _VueQuickLoadmore2 = _interopRequireDefault(_VueQuickLoadmore);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.component('quick-loadmore', _VueQuickLoadmore2.default);
...
new _vue2.default({
  ...
  methods: {
    handleTop: function handleTop() {
      ...
      // 下拉刷新
      setTimeout(function () {
        _this.dataList = [1, 2, 3, 4, 5];
        _this.$refs.vueLoad.onTopLoaded();
      }, 1000);
    },
    handleStatusChange: function handleStatusChange(status) {
      console.log(status, "statuschange");
    },
    handleBottomStatusChange: function handleBottomStatusChange(status) {
    ...
    handleBottom: function handleBottom() {
      ...
      // 上拉无限滚动加载
      setTimeout(function () {
        _this2.dataList.push(1, 2, 3);
        _this2.$refs.vueLoad.onBottomLoaded();
      }, 1000);
    }
  }
});
},{"vue":"node_modules/vue/dist/vue.common.js","./VueQuickLoadmore.vue":"src/VueQuickLoadmore.vue"}],"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.651aa9c2.map